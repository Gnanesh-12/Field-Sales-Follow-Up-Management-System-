...
exports.CustomerSitesController = void 0;
const common_1 = require("@nestjs/common");
const prisma_service_1 = require("../prisma/prisma.service");
const jwt_auth_guard_1 = require("../auth/jwt-auth.guard");
let CustomerSitesController = class CustomerSitesController {
    prisma;
    constructor(prisma) {
        this.prisma = prisma;
    }
...
exports.CustomerSitesController = CustomerSitesController;
__decorate([
    (0, common_1.Get)(),
...
exports.CustomerSitesController = CustomerSitesController = __decorate([
    (0, common_1.Controller)('customer-sites'),
    (0, common_1.UseGuards)(jwt_auth_guard_1.JwtAuthGuard),
    __metadata("design:paramtypes", [prisma_service_1.PrismaService])
], CustomerSitesController);
//# sourceMappingURL=customer-sites.controller.js.map