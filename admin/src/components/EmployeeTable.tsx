            ...
            employees.map((emp) => {
              ...
              return (
                <tr key={emp.id} className="hover:bg-white/10 transition-all duration-200 group">
                  <td className="p-5 font-mono font-bold text-[var(--text-main)] group-hover:text-indigo-300 transition-colors">{emp.id}</td>
                  ...
                  <td className="p-5 text-right space-x-3">
                    ...
                    <button
                      ...
                      className={`p-2 rounded-xl transition-all duration-300 inline-flex items-center border shadow-lg ${
                        isActive
